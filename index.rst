...
The language is an "intermediate language" because it is designed
to the middle part of a program verifier. A front-end translates
a program in some language to the Boogie IVL and a back-end tries
to verify the translated program. This provides "separation of concerns"
as
...
This idea is analagous to the "intermediate representation" (IR)
